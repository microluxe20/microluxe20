...
When creating a character, your player will be one of the major races of Terador. Terador has a wealth of races to choose from, each with their unique history. While the Mir are the most common race in Terador, the many other races are fairly commonplace to see as well.
...
Typically, Fighters or Paladins with Heavy armor are Slow, Rogues and Rangers are Fast, and the rest are Normal speed. When playing on a grid, 5ft. is approximately 1 square.
...
The Gamemaster may allow other characters to assist a character when performing a skill roll, when appropriate. A character being assisted in an action rolls twice, and takes the higher of the two rolls.
...
When creating a scroll, the infusion cost is reduced to 3 times the HP cost of the spell being scribed.
