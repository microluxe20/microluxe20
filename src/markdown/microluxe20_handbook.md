...
**Examples:** Kobolds have 1 hit die, so 1 kobold = 1 XP. 2 kobolds is double the amount of kobolds, so 2 kobolds = 2 XP (1 XP for first kobold + 1 XP for doubling). 4 kobolds is double the amount of kobolds again, so 4 kobolds = 3 XP, ( 1 XP for first kobold + 1 XP for doubling to 2 kobolds + 1 XP for doubling from 2 kobolds to 4 kobolds). A Black Bear has 3 hit die, so 1 black bear = 3 XP. 2 Black Bears = 4 XP. 4 Black Bears = 5 XP.
